    ...
    try {
      ...
      if (result.success) {
        addToast({
          ...
          description: 'Votre compte a été créé avec succès ! Vérifiez votre email pour confirmer l\'inscription.',
          type: 'success'
        })
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Rejoignez DesignMatch et connectez-vous avec la communauté UX/UI
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium mb-3">Je suis un :</label>
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button
                  type="button"
                  variant={formData.userType === 'recruiter' ? 'default' : 'outline'}
                  className="h-12"
